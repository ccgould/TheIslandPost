...
public class ControlExample : Control
{
    ...
    public static readonly DependencyProperty ApprovedPrintsProperty = DependencyProperty.Register(
    nameof(ApprovedPrints),
    ...
    public Dictionary<string,int>? ApprovedPrints
    {
        get => (Dictionary<string,int>)GetValue(ApprovedPrintsProperty);
        set => SetValue(ApprovedPrintsProperty, value);
    }
